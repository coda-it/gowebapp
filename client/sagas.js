...
function* root() {
    yield [
        takeEvery(applicationActionTypes.MOUNT, applicationSagas.onApplicationMount),
        ...
        takeEvery(categoriesActionTypes.ADD_CATEGORY, categoriesSagas.onAddCategory),
        takeEvery(categoriesActionTypes.UPDATE_CATEGORY, categoriesSagas.onUpdateCategory),
        takeEvery(categoriesActionTypes.DELETE_CATEGORY, categoriesSagas.onDeleteCategory),
        takeEvery(categoriesActionTypes.FETCH_CATEGORIES, categoriesSagas.onFetchCategories),
